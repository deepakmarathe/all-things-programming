...
//    public static int[][] parseFile(String inputFilePath, String delimiter, String dimention) throws IOException {
//        URL url = SudokuSolverDriver.class.getResource(inputFilePath);
//        File file = new File(url.getPath());
//        InputStream is = new FileInputStream(file);
//        return parseFile(is, delimiter, dimention);
//    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        BacktrackingSudokuSolver sudokuSolver = new BacktrackingSudokuSolver(board);
        sudokuSolver.solve();
